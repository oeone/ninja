  ...
  <div class="content">
    <div class="card">
      <div class="card-header">
        <div class="flex items-center justify-between">
          <p class="card-title">狗东登录提醒您</p>
        </div>
      </div>
      <div class="card-body text-base leading-6">
        <p>为了您的财产安全请关闭免密支付以及打开支付验密（🐶东-设置-支付设置-支付验密设置）。</p>
        <p>建议🐶东账户绑定微信以保证提现能到账。</p>
        <p>由于🐶东异地登录限制，扫码获取cookie只有2小时有效期，因此暂时关闭扫码功能，现需手动抓取Cookie。</p>
    ...
    <div v-if="showQR" class="card">
      <div class="card-header">
        ...
        <span class="card-subtitle">
          请点击下方按钮登录，点击按钮后回到本网站查看是否登录成功，🐶东的升级提示不用管。
        </span>
      </div>
    ...
    <div v-if="showWSCK" class="card">
      <div class="card-header">
        ...
        <div class="card-body text-base leading-6">
          <b>wskey有效期长达一年，请联系管理员确认使用（有一定危险性，慎用）</b>
    ...
    <div v-if="showCK" class="card">
      <div class="card-header">
        ...
        <div class="card-body text-base leading-6">
          ...
          <p>另外也可以使用抓包工具（iPhone：Stream，Android：HttpCanary）抓取🐶东app的ck，要注意pt_key和pt_pin字段是以app_open开头的。</p>
